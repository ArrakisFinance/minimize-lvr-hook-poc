...
import {IERC1155Receiver} from "v4-periphery/../lib/openzeppelin-contracts/contracts/token/ERC1155/IERC1155Receiver.sol";
import {ReentrancyGuard} from "v4-periphery/../lib/openzeppelin-contracts/contracts/security/ReentrancyGuard.sol";
import {SafeCast} from "v4-periphery/../lib/openzeppelin-contracts/contracts/utils/math/SafeCast.sol";
import {SafeERC20} from "v4-periphery/../lib/openzeppelin-contracts/contracts/token/ERC20/utils/SafeERC20.sol";
...
contract DiamondHookPoC is BaseHook, ERC20, IERC1155Receiver, ReentrancyGuard {
    ...
    PoolManager.PoolKey public poolKey;
